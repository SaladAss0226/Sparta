...
class NobodyAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    companion object{
        var unAssignList = listOf<PostMissionItem>()

        private var listener: NobodyAdapter.mItemClickListener? = null         //本地listener
        fun setToClick(listener: NobodyAdapter.mItemClickListener){         //fragment會呼叫此方法並在那邊override toClick這個方法 好讓下面的setOnClickListener可以用
